const CACHE="hide-seek-runtime-20260907-v3";
const CORE=[
  "./","./index.html","./styles.css","./hide-runtime.css","./hide-bridge.css","./app.js","./hide-runtime.js","./hide-bridge.js","./manifest.json","./assets/asset-map.json",
